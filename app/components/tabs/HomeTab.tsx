    ...
    <div className="flex flex-col justify-between min-h-[calc(100dvh-64px)] px-7 pt-16 pb-10">
      ...
      <div className="fade-up delay-1">
        ...
        <div className="my-3 w-full flex justify-center items-center gap-2">
          <Image src="/running.png" alt="The Kingdom" width={350} height={250} loading="eager" />
        </div>
      ...
      {/* Bottom: nav links */}
      <nav className="fade-up delay-3 flex flex-col">
        {[
          ...
          <button
            ...
            className="flex items-center justify-between py-[14px] border-t border-brown/10 last:border-b group text-left"
          >
